...
<a href="https://msf-companion.example.com/subscribe" style="display: inline-block; background: #f59e0b; color: #000; padding: 12px 24px; border-radius: 9999px; text-decoration: none; font-weight: 600; font-size: 14px;">Update Payment Method →</a>
</div>
