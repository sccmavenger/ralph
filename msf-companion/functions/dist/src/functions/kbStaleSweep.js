...
exports.sweepStaleDocuments = sweepStaleDocuments;
...
async function sweepStaleDocuments(deps, context) {
    const byType = {};
    let totalRemoved = 0;
...
async function queryStaleDocsFromSearch(sourceType, olderThan) {
...
async function deleteDocsFromSearch(docIds) {
    if (docIds.length === 0)
        return 0;
    let deleted = 0;
    const batchSize = 100;
...
functions_1.app.timer("kbStaleSweep", {
...
//# sourceMappingURL=kbStaleSweep.js.map