...
async function syncMeta(deps, context) {
    ...
    for (const mode of modes) {
        try {
            ...
            for (let i = 0; i < top50.length; i++) {
                ...
                allDocs.push((0, kbGameData_js_1.generateTeamMetaDoc)(teamData, mode.name));
            }
...
async function fetchCharacterNamesFromAPI() {
    const names = new Map();
...
async function fetchMetaTeamsFromAPI(_mode, endpoint) {
...
functions_1.app.timer("kbMetaSync", {
...
//# sourceMappingURL=kbMetaSync.js.map