...
exports.findConflictingTier4Docs = findConflictingTier4Docs;
 ...
 */
async function findConflictingTier4Docs(newDoc, deps) {
    // Only check conflicts when the new doc is Tier 1-3
    if (newDoc.sourceTier >= 4)
        return [];
 ...
 */
async function removeDocuments(docIds, deps) {
    if (docIds.length === 0)
        return;
    if (deps) {
...
//# sourceMappingURL=kbConflictResolver.js.map